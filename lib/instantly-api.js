...
class InstantlyAPI {
  constructor(apiKey) {
    this.apiKey = apiKey
    this.baseURL = 'https://api.instantly.ai/api'
    this.headers = {
  ...
  async testConnection() {
    try {
      const response = await axios.get(`${this.baseURL}/campaign/list`, {
  ...
  async addLeadsToCampaign(campaignId, leads) {
    try {
      const response = await axios.post(`${this.baseURL}/lead/add`, {
  ...
  async createCampaign(campaignData) {
    try {
      const response = await axios.post(`${this.baseURL}/campaign/create`, campaignData, {
        headers: this.headers
      })
      return response.data
    } catch (error) {
  ...
  async getCampaignStats(campaignId) {
    try {
      const response = await axios.get(`${this.baseURL}/campaign/stats`, {
