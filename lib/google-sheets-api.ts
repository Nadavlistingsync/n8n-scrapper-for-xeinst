...
class GoogleSheetsAPI {
  ...
  async ensureSheet(sheetName: string) {
    try {
  ...
  async syncEmailCampaign(leads: Lead[]) {
    try {
  ...
  // Sync analytics
  async syncAnalytics(analytics: any) {
    try {
...
export async function initializeGoogleSheetsAPI(): Promise<GoogleSheetsAPI | null> {
  if (googleSheetsAPI) {
...
export async function syncToGoogleSheets(leads: Lead[], analytics?: any) {
