...
async function scrapeAIAutomation() {
  console.log('ℹ️  🚀 Starting AI automation platform scraping...');
  ...
  // AI and automation platform search queries
  const searchQueries = [
    // AI Platforms
    'openai webhook language:javascript language:typescript language:json',
    'anthropic webhook language:javascript language:typescript language:json',
    'claude webhook language:javascript language:typescript language:json',
    'gpt webhook language:javascript language:typescript language:json',
    'llm webhook language:javascript language:typescript language:json',
    'ai agent webhook language:javascript language:typescript language:json',
    'chatgpt webhook language:javascript language:typescript language:json',
    'bard webhook language:javascript language:typescript language:json',
    'gemini webhook language:javascript language:typescript language:json',
    
    // Automation Platforms
    'zapier webhook language:javascript language:typescript language:json',
    'ifttt webhook language:javascript language:typescript language:json',
    'integromat webhook language:javascript language:typescript language:json',
    'automate.io webhook language:javascript language:typescript language:json',
    'workato webhook language:javascript language:typescript language:json',
    'tray.io webhook language:javascript language:typescript language:json',
    'pipedream webhook language:javascript language:typescript language:json',
    'retool webhook language:javascript language:typescript language:json',
    'bubble webhook language:javascript language:typescript language:json',
    'airtable webhook language:javascript language:typescript language:json',
    
    // Specific AI Tools
    'langchain webhook language:javascript language:typescript language:json',
    'pinecone webhook language:javascript language:typescript language:json',
    'weaviate webhook language:javascript language:typescript language:json',
    'chroma webhook language:javascript language:typescript language:json',
    'milvus webhook language:javascript language:typescript language:json',
    'qdrant webhook language:javascript language:typescript language:json',
    'cohere webhook language:javascript language:typescript language:json',
    'huggingface webhook language:javascript language:typescript language:json',
    
    // Business Automation
    'salesforce webhook language:javascript language:typescript language:json',
    'hubspot webhook language:javascript language:typescript language:json',
    'pipedrive webhook language:javascript language:typescript language:json',
    'notion webhook language:javascript language:typescript language:json',
    'slack webhook language:javascript language:typescript language:json',
    'discord webhook language:javascript language:typescript language:json',
    'telegram webhook language:javascript language:typescript language:json',
    'whatsapp webhook language:javascript language:typescript language:json'
  ];
...
module.exports = { scrapeAIAutomation } 