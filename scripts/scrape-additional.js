...
async function scrapeAdditional() {
  console.log('ℹ️  🚀 Starting additional n8n repository scraping...');
  ...
  const searchQueries = [
    'n8n automation language:javascript language:typescript language:json',
    'n8n integration language:javascript language:typescript language:json',
    'n8n workflow language:javascript language:typescript language:json',
    'n8n custom node language:javascript language:typescript language:json',
    'n8n extension language:javascript language:typescript language:json',
    'n8n plugin language:javascript language:typescript language:json',
    'n8n connector language:javascript language:typescript language:json',
    'n8n api language:javascript language:typescript language:json'
  ];
  ...
  for (const query of searchQueries) {
    ...
    if (searchQueries.indexOf(query) < searchQueries.length - 1) {
      console.log('ℹ️  ⏳ Waiting 5 seconds before next search query...');
...
module.exports = { scrapeAdditional } 